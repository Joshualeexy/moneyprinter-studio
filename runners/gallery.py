...
"""
==============================================================================
MoneyPrinter Studio - Unified Video Gallery & Web Player
==============================================================================
First-party web server and interactive video player gallery for MoneyPrinter Studio.
...
def ensure_gallery_server_running(port=DEFAULT_PORT):
    ...
    cmd = [sys.executable, gallery_script, "--port", str(port)]
    try:
        subprocess.Popen(
            cmd,
            cwd=WORKSPACE_ROOT,
...
<head>
    ...
    <title>MoneyPrinter Studio - Video Gallery & Player</title>
...
<body>
    ...
    <header>
        <div class="brand">
            ...
            <div class="brand-title">MoneyPrinter Studio</div>
        </div>
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="MoneyPrinter Studio Video Gallery & Web Server")
